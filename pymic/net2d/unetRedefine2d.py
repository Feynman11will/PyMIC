...
class UNetBlock(nn.Module):
    def __init__(self,in_channels, out_channels, acti_func, acti_func_param):
        ...
        self.conv3 = ConvolutionLayer(in_channels, out_channels, 3,
                                      dim=2, padding=1, acti_func=get_acti_func(acti_func, acti_func_param))

        self.conv4 = ConvolutionLayer(out_channels, out_channels, 3,
                                      dim=2, padding=1, acti_func=get_acti_func(acti_func, acti_func_param))
...
class UNet2DRe(nn.Module):
    def __init__(self, params):
        super(UNet2DRe, self).__init__()
        self.params = params
