...
def get_transform(name, params):
    if (name == "CropWithBoundingBox"):
        ...
        output_size = params["Pad_output_size".lower()]# [8,8,8]
        ceil_mode   = params["Pad_ceil_mode".lower()]#True
        inverse = params["Pad_inverse".lower()]# False
        ...
        class_num = params['LabelToProbability_class_num'.lower()] #2 
        inverse   = params['LabelToProbability_inverse'.lower()] # False
